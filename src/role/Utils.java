...
public class Utils {
    ...
    /**
     * Distance units moved horizontally per standard move action for an
     * Outlander.
     */
    public static final float OUTLANDER_MOVE = 8.5f;

    /**
     * Distance units moved vertically per standard jump action for an
     * Outlander.
     */
    ...
    /**
     * Distance units moved horizontally per standard move action for a
     * Constructor.
     */
    public static final float CONSTRUCTOR_MOVE = 5.0f;

    /**
     * Distance units moved vertically per standard jump action for a
     * Constructor.
     */
    ...
    /**
     * Default number of lives assigned to every role at creation or after a
     * reset.
     */
