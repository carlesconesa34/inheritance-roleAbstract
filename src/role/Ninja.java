...
/**
 * Concrete implementation of Role representing a Ninja character.
 *
...
public class Ninja extends Role {
	...
	/**
	 * Creates a new Ninja at the specified position on the 2-D plane.
	 *
	...
	/**
	 * Moves the Ninja a fixed number of units along the X axis and consumes the
	...
	/**
	 * Makes the Ninja jump a fixed number of units along the Y axis and consumes
	...
	/**
	 * Returns a string representation of this Ninja, prefixed with the character
	 * type and followed by the common Role state.
	 *
