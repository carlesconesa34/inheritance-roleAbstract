...
public class Soldier extends Role {
	...
	/**
	 * Moves the Soldier a fixed number of units along the X axis and consumes the
	...
	/**
	 * Makes the Soldier jump a fixed number of units along the Y axis and consumes
	...
	/**
	 * Returns a string representation of this Soldier, prefixed with the character
